...
- AI가 제시하는 출처 URL이 실재하지 않는 경우가 있습니다. 링크는 참고용으로만 사용하시고 반드시 원문을 확인하시기 바랍니다.
- 법률 정보는 수시로 개정되므로 최신 상태가 아닐 수 있습니다.

## 면책 조항

이 서비스는 일반적인 정보 제공을 목적으로 하며, **법률 자문을 대체할 수 없습니다.** 구체적인 법률 문제는 반드시 전문 변호사와 상담하시기 바랍니다. 제공된 정보의 정확성이나 완전성을 보장하지 않으며, 이를 근거로 한 판단에 대해 책임지지 않습니다.

## 문의

- 서비스 문의: support@lawornot.com
- 개발 문의: lyg@lawornot.com
